...
var {setUpLocalDeps, getLocalDeps} = require("./asyncLocalDeps");
    ...
    diff: function () {
      ...
      for (const key of Object.keys(currentDeps)) {
        if (!(key in snapshot)) {
          ...
          if (current && snapshotValue && typeof current.getValue === 'function' && typeof snapshotValue.getValue === 'function') {
            try {
