...
exports.signalDone = signalDone;
exports.waitFor = waitFor;
exports.withSignalMutex = withSignalMutex;
/**
 ...
 */
function waitFor(signalName, timeout = 5000, continueOnTimeout = false) {
  ...
  return new Promise((resolve, reject) => {
    ...
    // Set up a waiter
    const existingSignal = signals.get(signalName) || {
      waiters: []
    };
 ...
 */
function signalDone(signalName, value, keepPreviousValue = false, removeAfterDone = false) {
...
async function withSignalMutex(signalName, fn, timeout = 5000, maxWaits = 10) {
