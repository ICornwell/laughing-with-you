...
import { beforeAllWithLocalDeps, beforeEachWithLocalDeps, itWithLocalDeps, afterEachWithLocalDeps, afterAllWithLocalDeps } from '../../src/vitest/testWrappers';
...
describe('Dependency Snapshot', () => {
  ...
  runWithLocalDeps({}, () => {
    ...
    beforeAll(() => {
      ...
      process.env.DEBUG = 'true'; // Enable debug mode for longer timeouts
    })
